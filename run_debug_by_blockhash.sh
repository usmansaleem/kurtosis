...
curl -s -X POST \
  ...
  | jq . \
  > output/besu_block_output.json

echo "Done. Results saved to output/geth_block_output.json and output/besu_block_output.json"
